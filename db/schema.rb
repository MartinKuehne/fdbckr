...
ActiveRecord::Schema.define(version: 2021_06_02_103408) do
  ...
  create_table "feedback_requests", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["artwork_id"], name: "index_feedback_requests_on_artwork_id"
  ...
  add_foreign_key "feedback_requests", "artworks"
